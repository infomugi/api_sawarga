                            ...
                            <table id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important" width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
                                <tbody><tr>
                                            ...
                                            <td valign="top" align="center">
                                                ...
                                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                    <tbody><tr>
                                                        <td valign="top" align="center">
                                                            <!-- FLEXIBLE CONTAINER // -->
                                                            <table class="flexibleContainer" width="500" cellspacing="0" cellpadding="10" border="0">
                                                                <tbody><tr>
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                            <tbody><tr>
                                                                                <!--
                                                                                    ...
                                                                                    is visible.
                                                                                -->
                                                                                <td id="invisibleIntroduction" class="flexibleContainerBox" style="display:none !important" valign="middle" align="left">
                                                                                ...
                                                                                <td class="flexibleContainerBox" valign="middle" align="right">
                                                                                    <table style="max-width:100%" width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                        <tbody><tr>
                                                                                            <td class="textContent" align="left">
                                                                                                <!-- CONTENT // -->
                                    ...
                                    <!--
                                        ...
                                        that spans the width of the page.
                                    -->
                                    <table id="emailBody" width="500" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF">
                                        ...
                                        <tbody><tr>
                                            <td valign="top" align="center">
                                                ...
                                                -->
                                                <table style="color:#FFFFFF" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#3498db">
                                                    <tbody><tr>
                                                        <td valign="top" align="center">
                                                            <!-- FLEXIBLE CONTAINER // -->
                                                            <!--
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                            <tbody><tr>
                                                                                <td class="textContent" valign="top" align="center">
                                                                                    <img src="http://wefay.com/images/logo.png" alt="" style="max-width:200px;width:100%;display:block">
                                                                                </td>
                                                                            </tr>
                                                                        </tbody></table>
                                                                        <!-- // CONTENT TABLE -->
                                                                                    ...
                                                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                                                        <tbody><tr>
                                                                                            <td class="textContent" valign="top">
                                                                                                <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left">Informasi</h3>
                                                                            ...
                                                                            <table width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                                                                                <tbody><tr>
                                                                                    <td class="flexibleContainerBox" style="background-color:#5F5F5F" valign="top" align="left">
                                                                                        <table style="max-width:100%" width="100%" cellspacing="0" cellpadding="30" border="0">
                                                                                            <tbody><tr>
                                                                                                <td class="textContent" align="left">
                                                                                    ...
                                                                                    <td class="flexibleContainerBox" style="background-color:#3498DB" valign="top" align="right">
                                                                                            ...
                                                                                            <tbody><tr>
                                                                                                <td class="textContent" valign="top">
                                                                                                    <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#cccccc;line-height:150%">
                                                                                                        <p style="color:#999999;font-size:14px;line-height:20px;font-family:Arial,Helvetica,sans-serif;margin-top:0;margin-bottom:12px;padding-top:0;padding-bottom:0;font-weight:normal"><strong><a href="#" style="color:#0088cc" target="_blank">Like On Facebook</a></strong> | <strong><a href="#" style="color:#0088cc" target="_blank">Follow
                                                                                                           On
